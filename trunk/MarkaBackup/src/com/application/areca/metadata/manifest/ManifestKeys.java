...
//    public static final String VERSION_DATE = "Version Tarihi";
...
//    public static final String ARECA_HOME = "Robust Backup Home";
//    
...
//    public static final String OPTION_BACKUP_SCHEME = OPTION_PREFIX + "backup scheme" + OPTION_SUFFIX;
    ...
    public static final String VERSION_DATE = "Version Tarihi";
    public static final String BUILD_ID = "Build id";
    public static final String FILTERED_ENTRIES = "Filtrelen Dosya ve klas\u00f6rler";
    public static final String BACKUP_DURATION = "Yedekleme Suresi";
    public static final String TARGET_ID = "Target ID";
    public static final String CHECKED = "Kontrol Yap\u0131ld\u0131 m,";
    public static final String MERGE_START = "Merge start date";
    public static final String MERGE_END = "Merge end date";
    public static final String MERGED_ARCHIVES = "Merged archives";
    public static final String ARCHIVE_NAME = "Arsiv Adi";
    public static final String CURRENT_ARCHIVE_PATH = "Arsiv yeri";
    public static final String STORED_FILES = "Kaydedilen Dosyalar";
    public static final String UNMODIFIED_FILES = "Kaydedilmeyen Dosyalar(De\u011fi\u015fmemi\u015f dosyalar)";
    public static final String ARCHIVE_SIZE = "Ar\u015fiv Boyutu";
    public static final String UNFILTERED_DIRECTORIES = "Filtrelenmeyen klas\u00f6rler";
    public static final String UNFILTERED_FILES = "Filtrelenmeyen klas\u00f6rler";
    public static final String SCANNED_ENTRIES = " Taranan girdiler (Dosya veya Klasor)";
    public static final String SOURCE_PATH = "Kaynak dizin";
    public static final String ENCODING = "File encoding";
    public static final String OS_NAME = "\u0130\u015fletim Sistemi";
    public static final String IS_RESUMED = "Resumed";
    public static final String JRE = "JRE";
    public static final String ARECA_HOME = "Robust Backup Home";
